...
class JSONRpcTransport extends import_core.Experimental_CoreClient {
  ...
  async dryRunTransaction(options) {
    ...
    return {
      transaction: {
        ...
        signatures: [],
        transaction: (0, import_utils2.parseTransactionBcs)(options.transaction)
      }
    };
  }
  ...
  resolveTransactionPlugin() {
    return (0, import_json_rpc_resolver.resolveTransactionPlugin)(__privateGet(this, _jsonRpcClient));
  }
}
...
function parseTransaction(transaction) {
  ...
  return {
    ...
    effects: (0, import_utils2.parseTransactionEffectsBcs)(new Uint8Array(transaction.rawEffects)),
    objectTypes: Promise.resolve(objectTypes),
    transaction: {
      ...data,
      bcs: bytes
