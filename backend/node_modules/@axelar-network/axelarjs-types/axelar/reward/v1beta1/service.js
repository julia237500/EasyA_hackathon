...
const tx_1 = require("../../../axelar/reward/v1beta1/tx");
const query_1 = require("../../../axelar/reward/v1beta1/query");
...
class MsgServiceClientImpl {
    ...
    RefundMsg(request) {
        ...
        return promise.then((data) => tx_1.RefundMsgResponse.decode(new _m0.Reader(data)));
    }
}
...
class QueryServiceClientImpl {
    ...
    InflationRate(request) {
        ...
        return promise.then((data) => query_1.InflationRateResponse.decode(new _m0.Reader(data)));
    }
    Params(request) {
