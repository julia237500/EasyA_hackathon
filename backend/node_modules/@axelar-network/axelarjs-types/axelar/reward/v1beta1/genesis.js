...
const types_1 = require("../../../axelar/reward/v1beta1/types");
...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            ...
            pools: Array.isArray(object === null || object === void 0 ? void 0 : object.pools) ? object.pools.map((e) => types_1.Pool.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
