...
class AxelarGMPRecoveryAPI extends AxelarRecoveryApi_1.AxelarRecoveryApi {
    ...
    addGasToStellarChain(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const chainInfo = yield this.findChainInfo("stellar");
            if (!chainInfo)
                throw new Error("Stellar chain config not found");
            const { senderAddress, messageId, contractAddress, tokenAddress, amount, spender, rpcUrl } = params;
            const { config: chainConfig } = chainInfo;
            ...
            const networkPassphrase = this.environment === types_1.Environment.MAINNET
    ...
    findChainInfo(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const chainKey = Object.keys(chains).find((chainName) => chainName === chain) ||
